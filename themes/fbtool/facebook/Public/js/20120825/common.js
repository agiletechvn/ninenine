	...
	$.fn.extend({
		...
		setMyTab:function(){ //管理中心 tab导航
			...
			var arrNav=[
						...
						{"tag":"tool","name":"我的道具","loc":2},
						//{"tag":"wishing","name":"我的许愿","loc":4},
						{"tag":"showadmin","name":"我的房管","loc":3},
						//{"tag":"family","name":"我的家族","loc":6},
						{"tag":"interestByList","name":"我的粉丝","loc":4},
						{"tag":"info","name":"我的个人设置","loc":5},
						{"tag":"get","name":"我的账单","loc":6},
						{"tag":"listAward","name":"我的账单","loc":6},
						{"tag":"exchange","name":"我的兑换","loc":9},
						{"tag":"settlement","name":"我的结算","loc":10}
	...
	add:function(){
		...
		try{
			...
			try{
				...
				alert("Xin lỗi, trình duyệt của bạn không hỗ trợ chức năng này, hay nhấn CTRL+D để lưu trang");
			}
		}	
	},
