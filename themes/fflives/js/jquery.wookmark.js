...
jQuery.fn.wookmark = function(options) {
  ...
  this.wookmarkLayoutFull = function(columnWidth, columns, offset) {
    ...
    for(; i<length; i++ ) {
      ...
      // calculate height
      //var rate = parseInt(item.attr('height')) / parseInt(item.attr('width'));
      //var height = Math.floor(this.wookmarkOptions.itemWidth * rate);
      
      // option auto height, but will be slow 'cos we have to wait for images to be loaded
      var height = item.outerHeight();
      
      // Update column height.
      heights[shortestIndex] = shortest + height + this.wookmarkOptions.offset;
