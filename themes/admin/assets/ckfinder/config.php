 ...
 * Some modules will upload and delete each image belong to item
 * But some items share the same url of the upload folder, that is media editor
 */
...
function CheckAuthentication()
{
	...
	//return (isset($_SESSION['user']) && (($group = $_SESSION['user']['group']) == 'admin' || in_array($group, array('author','editor'))));
	//return false;
    return true;
}
